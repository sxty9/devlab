...
// (task requirement 10): the axiom tree, the run/ToDo lists, the calendars, the execution history, the
// live-run pointer, the live-follow view and the Lieferungen surface all ride this one stream.
//
 ...
 *  (task requirement 11). The editor keeps the user's draft regardless; this only surfaces the conflict.
