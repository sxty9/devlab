...
export const dataSource: DataSource = {
  ...
  mercuryDeliveries: (repo) => impl.mercuryDeliveries(repo),
  mercuryRollbackDelivery: (id) => impl.mercuryRollbackDelivery(id),
  mercuryResetRepo: (repo) => impl.mercuryResetRepo(repo),
