 ...
 *  back on its own (task requirement 12), and close() stops it for good (no load from a closed view). */
 ...
 *  silently overwriting (task requirement 11). The editor keeps its draft regardless; this only
