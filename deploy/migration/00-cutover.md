...
| 10 | Verzweigungsschutz direkt nach der Anlage (`api/exec_deps.go:716 ops.ProtectDefaultBranch`) | nein — nur mit 9 | den Schutz des Standard-Branches des neu angelegten Repositories | wie 6 |
